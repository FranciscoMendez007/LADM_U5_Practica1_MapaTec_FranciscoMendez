package mx.edu.ittepic.ladm_u5_practica1_mapatec_franciscomendez
...
class Data {
    ...
    fun estoyEn(posicionActual: GeoPoint):Boolean{
        //logica es similar a la clase figura geometrica de canvas y concretamente
        //estoyEn es muy muy similar a estaEnArea
        if (posicionActual.latitude>=posicion1.latitude && posicionActual.longitude <= posicion2.latitude){
